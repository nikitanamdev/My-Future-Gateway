...
<html>
    ...
    background: url("https://media.wired.com/photos/593240ca58b0d64bb35d07ce/4:3/w_660,c_limit/hexwave.gif");
...
try
{
   ...
   // PreparedStatement ps1=con.prepareStatement("select * from TEAM");
	...
	<button class='button2' value="submit" type="submit" onclick="window.location.href='answers2.jsp?scr='+s+'&Count='+numCorrect+'&t='+t">Next Level</button>
 ...
 //   for (var i = 0; i < selections.length; i++) {
    ...
    document.getElementById("score").innerHTML= "Score: " + s;
    if(i==3)
   		 return "Your level 2 has completed!";
  }
})();	
